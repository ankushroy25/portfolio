...
const About = () => {
  return (
    <div name="about" className="w-full h-screen text-gray-300 sm:p-10 md:p-24">
      <div className="flex flex-col justify-center items-center w-full h-full border-gray-400 border-4 lg:rounded-3xl sm:rounded-lg">
